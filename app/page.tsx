...
export default function Home() {
  ...
  return (
    <main className={`${darkMode ? "dark" : ""} `}>
      <div className="pt-2 min-h-screen overflow-hidden fade-in-0 animate-in animate-out duration-700 bg-white dark:bg-gray-900 dark:text-white">
        <nav className="px-2 mt-2 flex justify-between sm:justify-around items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="text-lg font-semibold border rounded-md shadow-md border-black/70 px-4 py-1 hover:scale-105 transition-all dark:border-white">
              Try now!
            </button>
          </div>
        </nav>
        ...
        <div className="flex justify-evenly mt-16 flex-wrap space-y-8 sm:space-y-0 dark:text-gray-300">
          <div className="border border-black/50 w-80 p-3 rounded-lg shadow-lg dark:border-white">
      ...
      <footer className="font-semibold text-sm text-center py-4 dark:bg-gray-900 dark:text-gray-300">
