      ...
      >
        <div className="h-full px-3 py-4 flex flex-col justify-between overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-black bg-orange-300 rounded-full dark:bg-blue-900 dark:text-blue-300">
                    3
                  </span>
                </a>
              </li>
          ...
          <div className="flex justify-between items-center">
            <p className="dark:text-white">Email: {user && user.email}</p>
            <div
